  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 animate-fade-in">
      <Button 
        variant="ghost" 
        onClick={() => navigate('/')}
        className="mb-6 flex items-center gap-2 rounded-xl text-white border border-white/10 hover:bg-white/10"
      >
        <ArrowLeft size={16} />
        Back to Home
      </Button>
      ...
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center gradient-heading flex justify-center items-center gap-2">
          ...
          About LifePath
          <Sparkles className="h-6 w-6 text-primary animate-pulse-slow" style={{ animationDelay: '0.5s' }} />
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-10">
          <Card className="teen-card p-6 hover-lift animate-scale-in" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full">
          ...
          <Card className="teen-card p-6 hover-lift animate-scale-in" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center gap-4 mb-4">
        ...
        <Card className="teen-card p-6 mb-8 md:mb-10 animate-scale-in" style={{ animationDelay: '0.3s' }}>
          <div className="flex items-center gap-4 mb-4">
            <div className="p-3 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full">
        ...
        <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-white/20 p-6 backdrop-blur-sm animate-scale-in" style={{ animationDelay: '0.4s' }}>
          <div className="flex items-center gap-4 mb-4">
            <div className="p-3 bg-white/10 backdrop-blur-sm rounded-full">
              <Heart className="text-neon-pink" />
            </div>
            <h2 className="text-lg md:text-xl font-bold text-white">Our Mission</h2>
          </div>
          <p className="mb-4 text-white/90">
