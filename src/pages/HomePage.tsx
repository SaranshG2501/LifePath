...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12">
      <section className="text-center mb-16 animate-fade-in">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {!userRole || userRole === 'guest' ? (
              <Button 
                ...
                className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white shadow-lg hover:shadow-blue-500/20 transition-all"
              >
          ...
          <div className="flex flex-wrap justify-center items-center gap-3">
            {gameMode === "classroom" ? (
              <Badge className="py-1.5 px-3 bg-blue-500/20 text-white border-0 rounded-full flex items-center gap-1.5">
      ...
      <section className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-white/10 backdrop-blur-md rounded-xl p-8 mb-16 animate-fade-in" style={{ animationDelay: "0.5s" }}>
      ...
      <section id="classroom-section" className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-white/10 backdrop-blur-md rounded-xl p-8 mb-16 animate-fade-in" style={{ animationDelay: "0.6s" }}>
      ...
      <section className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-white/10 backdrop-blur-md rounded-xl p-8 animate-fade-in" style={{ animationDelay: "0.7s" }}>
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="bg-black/40 p-6 rounded-lg shadow-lg border border-white/10 backdrop-blur-md max-w-md hover:border-blue-300/30 transition-all">
              <div className="bg-blue-500/10 p-3 rounded-lg mb-3 flex justify-center">
