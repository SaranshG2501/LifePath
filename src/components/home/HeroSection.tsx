...
const HeroSection = () => {
  ...
  return (
    <section className="relative text-center mb-12 sm:mb-16 animate-fade-in">
      <div className="max-w-4xl mx-auto relative">
        {/* Animated Background Elements */}
        <div className="absolute -top-10 left-1/4 w-6 h-6 text-primary/30 animate-float">
          <Sparkles className="w-full h-full" />
        </div>
        <div className="absolute top-0 right-1/4 w-4 h-4 text-accent/40 animate-bounce-in" style={{ animationDelay: '0.5s' }}>
          <Zap className="w-full h-full" />
        </div>
        <div className="absolute -top-5 left-1/3 w-2 h-2 bg-secondary/40 rounded-full animate-pulse-glow" style={{ animationDelay: '1s' }} />

        {/* Hero Icon with Enhanced Animation */}
        <div className="inline-flex justify-center items-center p-3 sm:p-4 bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full mb-6 sm:mb-8 shadow-2xl shadow-primary/20 backdrop-blur-sm border border-primary/30 animate-pulse-glow hover:animate-wiggle transition-all duration-300 group">
        ...
        <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
          <p className="text-xl sm:text-2xl md:text-3xl font-medium text-white/90 animate-text-reveal" style={{ animationDelay: '0.3s' }}>
            Real Life Based Decision Simulator
          </p>
          <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto px-4 animate-text-reveal" style={{ animationDelay: '0.6s' }}>
            Navigate realistic scenarios and shape your future through thoughtful choices
          </p>
        </div>
        
        {/* Animated Action Buttons */}
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-8 sm:mb-10 px-4 animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
          ...
          <Button 
            ...
            variant="outline" 
            className="group flex items-center gap-2 border-white/30 bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all duration-300 transform hover:scale-105 hover:animate-tilt"
          >
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 px-4 animate-bounce-in" style={{ animationDelay: '1.2s' }}>
