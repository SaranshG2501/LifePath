...
const AppHeader: React.FC = () => {
  ...
  return <header className="border-b-2 border-neon-purple/30 bg-gradient-to-r from-slate-900/95 via-purple-900/90 to-indigo-900/95 backdrop-blur-xl shadow-2xl shadow-neon-purple/20 sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center relative z-10">
        ...
        <div className="flex items-center gap-3">
          {!isGameActive && <>
              <Button variant="ghost" size="sm" asChild className="rounded-xl text-white hover:bg-gradient-to-r hover:from-neon-blue/20 hover:to-neon-purple/20 hover:text-neon-blue border-2 border-transparent hover:border-neon-blue/30 transition-all duration-300 px-4 py-3 font-semibold hover:scale-105">
              ...
              {userRole === "teacher" && <Button variant="ghost" size="sm" asChild className="rounded-xl text-white hover:bg-gradient-to-r hover:from-neon-green/20 hover:to-neon-blue/20 hover:text-neon-green border-2 border-transparent hover:border-neon-green/30 transition-all duration-300 px-4 py-3 font-semibold hover:scale-105">
              ...
              <Button variant="ghost" size="sm" asChild className="rounded-xl text-white hover:bg-gradient-to-r hover:from-neon-yellow/20 hover:to-neon-pink/20 hover:text-neon-yellow border-2 border-transparent hover:border-neon-yellow/30 transition-all duration-300 px-4 py-3 font-semibold hover:scale-105">
