...
const ClassroomManagement: React.FC<ClassroomManagementProps> = ({ isTeacher }) => {
  ...
  const handleCopyCode = () => {
    navigator.clipboard.writeText(demoClassCode);
    setCopied(true);
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-black/20 rounded-lg p-3 border border-white/10">
                  <div className="flex justify-between items-start">
                    <h4 className="text-white font-medium">Life Skills 203</h4>
                    <Badge className="bg-blue-500/20 text-blue-300 border-0">Inactive</Badge>
                  </div>
                  <p className="text-sm text-white/70 mt-1">Teacher: Mr. Davis</p>
                  <div className="flex justify-between items-center mt-3">
                    <div className="text-xs text-white/60">
                      No active scenario
                    </div>
