              ...
              <div className="relative p-4 sm:p-6">
                ...
                <div className="space-y-2 sm:space-y-3 mb-4">
                  ...
                  {entry.choices.map((choice, choiceIndex) => (
                    <div key={choiceIndex} className="bg-gradient-to-r from-slate-900/60 to-slate-800/40 rounded-lg p-3 sm:p-4 border border-slate-600/30 hover:border-secondary/40 transition-all duration-200">
